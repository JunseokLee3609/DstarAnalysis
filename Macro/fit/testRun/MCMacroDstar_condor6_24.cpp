...
void MCMacroDstar_condor(bool doReFit= false, bool plotFit = true,bool useCUDA=true, float pTMin=4, float pTMax=100, float cosMin=-2, float cosMax=2){
    ...
    std::string subDir = "/DStar_ppRef_absCos_Jul02_test_v1/";
    ...
    // // params[{0,0}].first.sigmaR_max = 0.005;
    // // params[{0,0}].first.sigmaL = 0.0005;
    // // params[{0,0}].first.sigmaL_min = 0.00005;
    // // params[{0,0}].first.sigmaL_max = 0.005;
    
    params[{0,0}].first.alphaL = 1.85;
    params[{0,0}].first.alphaL_min = 0.001;
    params[{0,0}].first.alphaL_max = 10;
    params[{0,0}].first.nL = 1.2;
    params[{0,0}].first.nL_min = 1.1;
    params[{0,0}].first.nL_max = 10;

    params[{0,0}].first.alphaR = 1.85;
    params[{0,0}].first.alphaR_min = 0.001;
    params[{0,0}].first.alphaR_max = 10.;
    params[{0,0}].first.nR = 1.85;
    params[{0,0}].first.nR_min = 1.1;
    params[{0,0}].first.nR_max = 10;
        ...
        params[{0,0}].second.p0_max = 0.1;
        params[{0,0}].second.p1 = -1;
        params[{0,0}].second.p1_min = -100.0;
        params[{0,0}].second.p1_max = 100;
        params[{0,0}].second.p2 = 0.001;
        params[{0,0}].second.p2_min = -100.0;
