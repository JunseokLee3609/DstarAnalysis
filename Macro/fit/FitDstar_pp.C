...
void FitDstar_pp() {
    ...
    // MassFitter fitter_dstar("PbPb","massPion");
    ...
    // Load your data
    // fitter.LoadData("/home/jun502s/DstarAna/DStarAna/data/DstarData_Rds_PbPb_250102_v1.root", "workspace", "dataset", true);
    // fitter_dstar.LoadData("/home/jun502s/DstarAna/DStarAna/data/DstarData_Rds_PbPb_241226.root", "workspace", "dataset", true);
    fitter_pp.LoadData("/home/jun502s/DstarAna/DStarAna/data/DstarData_Rds_CUDA_pp.root", "workspace", "dataset", false);
    ...
    MassFitter::DBCrystalBallParams sigParams_pp;
    sigParams_pp.mean = 0.1455;        // D* mass in GeV
    sigParams_pp.mean_min = 0.145;
    sigParams_pp.mean_max = 0.146;
    sigParams_pp.sigmaR = 0.0005;
    sigParams_pp.sigmaR_min = 0.0001;
    sigParams_pp.sigmaR_max = 0.001;
    sigParams_pp.sigmaL = 0.0005;
    sigParams_pp.sigmaL_min = 0.0001;
    sigParams_pp.sigmaL_max = 0.001;
    
    sigParams_pp.alphaL = 2.;
    sigParams_pp.alphaL_min = 0;
    sigParams_pp.alphaL_max = 10;
    sigParams_pp.nL = 1.5;
    sigParams_pp.nL_min = 1;
    sigParams_pp.nL_max = 10;

    sigParams_pp.alphaR = 2.;
    sigParams_pp.alphaR_min = 0.;
    sigParams_pp.alphaR_max = 10.;
    sigParams_pp.nR = 1.5;
    sigParams_pp.nR_min = 1;
    sigParams_pp.nR_max = 10;
    fitter_pp.MakeDBCrystalBall(sigParams_pp, "dstar_sig");
    

    MassFitter::PhenomenologicalParams bkgParams_pp;
    bkgParams_pp.p0 = 0.1;
    bkgParams_pp.p0_min = 0.0;
    bkgParams_pp.p0_max = 5.0;
    bkgParams_pp.p1 = 2;
    bkgParams_pp.p1_min = -10.0;
    bkgParams_pp.p1_max = 10.0;
    bkgParams_pp.p2 = -5;
    bkgParams_pp.p2_min = -20.0;
    bkgParams_pp.p2_max = 20.0;
    fitter_pp.MakePhenomenological(bkgParams_pp, "bkg");
    ...
    // Combine PDFs
     for (const auto& bin : pTBins) {
        ...
        // TString CutPbPb = Form("pT > %f && pT < %f  && mva>-1", pTMin, pTMax);
        // TString Cutpp = Form("pT > %f && pT < %f ", pTMin, pTMax);

        // Reduce data with specific cuts
        // fitter.ReduceData(CutPbPb.Data());
        ...
        // fitter_pp.saveFitModel(pTMin,pTMax);
