...
void DrawSplotHist2D_cent(){
    ...
    for(size_t icent = 0; icent < centBins.size(); ++icent) {
        ...
        c_yield->SetGrid(1,1);
        c_yield->SaveAs(("splot_corrected_yield_cent_" + centLabel + ".png").c_str());
        delete c_yield;
        ...
        c_weight->SaveAs(("splot_weight_cent_" + centLabel + ".png").c_str());
        delete c_weight;
        ...
        latex.DrawLatex(0.25, 0.85, Form("cent = %.1f to %.1f", centBins[icent].first, centBins[icent].second));
        c_comp->SetGrid(1,1);
        c_comp->SaveAs(("splot_yield_comparison_cent_" + centLabel + ".png").c_str());
        delete leg;
        delete c_comp;
    }
