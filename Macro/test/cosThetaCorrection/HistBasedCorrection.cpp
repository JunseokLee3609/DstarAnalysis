...
std::string ResolveAnalysisBaseDir() {
    ...
    const std::string fallback = "/home/jun502s/DstarAna/DStarAnalysis/Macro/fit/testRun/";
...
void HistBasedCorrection(bool isMC /*=false*/, bool useAbsTheta /*=true*/){
    ...
    // Build efficiency map directly from MC sample
    std::string mcFilePath = "/home/jun502s/DstarAna/DStarAnalysis/Macro/skim/Data/FlatSample/ppMC/DStar/0916/flatSkimForBDT_DStar_DStar_MixPU_ppRef_MC_Sep16_v1_1_.root";
