...
void EffAccCalculator(
    ...
    auto fillGen = [&](int igen, double dzW, MC mcID){
        if((
            ...
            Dstar.SetPtEtaPhiM(evtPR.gen_pT[igen], evtPR.gen_eta[igen], evtPR.gen_phi[igen], evtPR.gen_mass[igen]);
            D0.SetPtEtaPhiM(evtPR.gen_D0pT[igen], evtPR.gen_D0eta[igen], evtPR.gen_D0phi[igen], evtPR.gen_D0mass[igen]);
            D1.SetPtEtaPhiM(evtPR.gen_D1pT[igen], evtPR.gen_D1eta[igen], evtPR.gen_D1phi[igen], evtPR.gen_D1mass[igen]);
            D0Dau1.SetPtEtaPhiM(evtPR.gen_D0Dau1_pT[igen], evtPR.gen_D0Dau1_eta[igen], evtPR.gen_D0Dau1_phi[igen], evtPR.gen_D0Dau1_mass[igen]);
            D0Dau2.SetPtEtaPhiM(evtPR.gen_D0Dau2_pT[igen], evtPR.gen_D0Dau2_eta[igen], evtPR.gen_D0Dau2_phi[igen], evtPR.gen_D0Dau2_mass[igen]);
            ...
            histoYCos[mcID]->Fill(Direction_y* evtPR.gen_y[igen], vect.CosTheta() , dzW);
            histoPhiCos[mcID]->Fill(evtPR.gen_phi[igen], vect.CosTheta() , dzW);
            histoPtCos[mcID]->Fill(evtPR.gen_pT[igen], vect.CosTheta() , dzW);
    ...
    auto fillReco = [&](int ireco, double dzW, MC mcID){
        if( evtPR.matchGEN[ireco] ){ 
            auto D0y= algo::rapidity(evtPR.pTD1[ireco], evtPR.EtaD1[ireco], evtPR.PhiD1[ireco], evtPR.massDaugther1[ireco]);
            ...
            TLorentzVector Dstar,D0;
                Dstar.SetPtEtaPhiM(evtPR.pT[ireco], evtPR.eta[ireco], evtPR.phi[ireco], evtPR.mass[ireco]);
            D0.SetPtEtaPhiM(evtPR.pTD1[ireco], evtPR.EtaD1[ireco], evtPR.PhiD1[ireco], evtPR.massDaugther1[ireco]);
            TVector3 vect = DstarDau1Vector_Helicity(Dstar,D0);
                count ++;
                // cout << vect.CosTheta()  << endl;
                    ...
                    histoYCosPass[mcID]->Fill(Direction_y * evtPR.y[ireco], vect.CosTheta()  , dzW);
                    histoPhiCosPass[mcID]->Fill(evtPR.phi[ireco], vect.CosTheta()  , dzW);
                    histoPtCosPass[mcID]->Fill(evtPR.pT[ireco], vect.CosTheta()  , dzW);
            }
        }
    };
