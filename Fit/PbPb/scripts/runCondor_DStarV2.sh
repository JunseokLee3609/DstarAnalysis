...
# Change to the correct directory for relative paths in DStarAnalysisPbPb.cpp
...
# Set environment variables for PbPb analysis
export USE_INTEGRATED_MC=1
...
echo "[Condor DStarV2] USE_INTEGRATED_MC=${USE_INTEGRATED_MC}"
